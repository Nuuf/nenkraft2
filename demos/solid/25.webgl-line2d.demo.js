...
export default () => {
  ...
  CreateDemo( 'WebGLLine2D', ( conf ) => {
    ...
    const pc = new nk2.Controller.ProgramController.GLLine2DProgramController( stage.gl );
    const path = new nk2.Path.Line2D( -100, -100, 100, 100 );
